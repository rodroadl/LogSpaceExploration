...
class FishColorAndIntensityDataset(Dataset):
    ...
    Use the correct transforms with this datset to output linear, jpg, or log images.
    Either linear_to_jpg_srgb, linear_to_float_linear, or linear_to_log should be the last transform applied before
    torch.tensor.
    """
